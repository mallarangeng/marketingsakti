...
<div class="col-lg-12">
        <div class="hpanel">
            <div class="panel-heading">
                ...
                DATA STOK KAVLING &nbsp;<a href="?r=kavling&pg=kav_entry&id_dev=<?php echo $_GET['id_dev']; ?>">TAMBAH<a>
            </div>
                ...
                <div class="table-responsive">
                 <table cellpadding="1" id="example2" cellspacing="1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                               <?php
							    $c=0;
                                $arrayKavling=$kavling->tampilKavling($id_dev);
                    ...
                    <tr>
                        ...
                        <td><a href="?r=kavling&pg=kav_edit&id_kavling=<?php echo $data['id_kavling'];?>&id_dev=<?php echo $_GET['id_dev']; ?>&aksi=edit">Edit</a></td>
                    </tr>
                    <?php
                    }
                    }
