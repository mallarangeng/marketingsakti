...
<div class="col-lg-12">
        <div class="hpanel">
            <div class="panel-heading">
                ...
                DATA STOK KAVLING &nbsp;<a href="?r=kavling&pg=kav_entry">TAMBAH<a>
            </div>
            <div class="panel-body">
                <div class="table-responsive">
                 <table cellpadding="1" cellspacing="1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                               <?php
                                $arrayKavling=$kavling->tampilKavling();
                    ...
                    <tr>
                        ...
                        <td><a href="<?php echo base_url() ?>index.php?r=kavling&pg=kav_edit&id_kavling=<?php echo $data['id_kavling'];?>&aksi=edit">Edit</a></td>
                    </tr>
                    <?php
                    }
                    }
