...
<div class="panel-body">
    <form method="get" class="form-horizontal">
        <div class="form-group">
            ...
            <div class="col-sm-4">
            <input type="text"  id="id_dev" class="form-control input-sm" value="DV<?php echo kdauto3('ms_devloper'); ?>">
            </div>
        </div>
        <div class="form-group">
		...
		<div class="form-group">
            ...
            <div class="col-sm-8">
               <input type="text" id="tot_luas_lahan" placeholder="Total Luas lahan" class="form-control input-sm" required></div>
            </div>
            ...
            <div class="col-sm-8">
                <input type="text" id="izin_lokasi" placeholder="Izin Lokasi" class="form-control input-sm" required></div>
            </div>
